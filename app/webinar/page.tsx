    ...
    <>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map(({ quote, name, location }) => (
              <div
                key={name}
                className="border-2 border-white p-10 card-hover"
              >
                <div className="label-text text-neutral-400 mb-8">Review</div>

                <blockquote className="display-font text-xl md:text-2xl font-bold leading-tight mb-8 italic">
                  &ldquo;{quote}&rdquo;
                </blockquote>
                ...
                <div className="border-t border-white pt-6">
                  ...
                  <div className="label-text text-neutral-400 mt-1">
                    {location}
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-6 md:px-10 bg-neutral-50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <Link
            href="/pricing"
            className="btn-secondary px-10 py-5 text-sm shrink-0 focus-visible:outline focus-visible:outline-3 focus-visible:outline-black focus-visible:outline-offset-3"
          >
            View Pricing →
          </Link>
        </div>
